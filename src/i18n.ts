...
const resources = {
  ...
  ig: {
    translation: {
      nav: { home: "Ụlọ", rooms: "Ọnụ ụlọ", offers: "Onyinye", dining: "Iri nri", gallery: "Ngosi", about: "Maka anyị", policies: "Iwu", contact: "Kpọtụrụ", bookNow: "Debe Ugbu a", guestPortal: "Pọtụlụ Ọbịa" },
  ...
  yo: {
    translation: {
      nav: { home: "Ile", rooms: "Yara", offers: "Ipese", dining: "Jijẹ", gallery: "Aworan", about: "Nipa wa", policies: "Ofin", contact: "Kan si", bookNow: "Wewe Bayi", guestPortal: "Ẹnu-ọna Alejo" },
  ...
  ha: {
    translation: {
      nav: { home: "Gida", rooms: "Daki", offers: "Tayi", dining: "Cin abinci", gallery: "Hotuna", about: "Game da mu", policies: "Dokoki", contact: "Tuntube mu", bookNow: "Yi Rajista", guestPortal: "Tashar Baƙo" },
  ...
  fr: {
    translation: {
      nav: { home: "Accueil", rooms: "Chambres", offers: "Offres", dining: "Restaurant", gallery: "Galerie", about: "À propos", policies: "Règlement", contact: "Contact", bookNow: "Réserver", guestPortal: "Portail Invité" },
  ...
  es: {
    translation: {
      nav: { home: "Inicio", rooms: "Habitaciones", offers: "Ofertas", dining: "Restaurante", gallery: "Galería", about: "Nosotros", policies: "Políticas", contact: "Contacto", bookNow: "Reservar", guestPortal: "Portal del Huésped" },
  ...
  it: {
    translation: {
      nav: { home: "Home", rooms: "Camere", offers: "Offerte", dining: "Ristorante", gallery: "Galleria", about: "Chi siamo", policies: "Politiche", contact: "Contatti", bookNow: "Prenota", guestPortal: "Portale Ospiti" },
