  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-40 pb-16 px-6 bg-zinc-900 text-center">
        <p className="text-gold text-xs uppercase tracking-[0.4em] mb-4">Restaurant & Facilities</p>
      ...
      <section className="py-16 px-6 bg-charcoal/50 border-t border-border">
        <div className="max-w-4xl mx-auto">
          <p className="text-gold text-xs uppercase tracking-[0.4em] mb-3 text-center">In-Room Restaurant Menu</p>
