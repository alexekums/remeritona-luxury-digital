...
export function SpaManagementView({ token, colors, onToast }: Props) {
  ...
  return (
    <div>
      ...
      {loading && displayBookings.length === 0 && (
        <p style={{ color: colors.textMuted, textAlign: "center", padding: 40 }}>Loading spa bookings…</p>
      )}
      {!loading && displayBookings.length === 0 && (
        <p style={{ color: colors.textMuted, textAlign: "center", padding: 40 }}>No spa bookings found</p>
      )}
